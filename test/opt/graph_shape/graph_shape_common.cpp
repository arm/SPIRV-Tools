...
auto genShader = [](std::vector<std::string> insElemTypes,
  ...
  for (auto& [_, ssa] : mapInputBindingIdAndSSA) {
    ...
    shader += strGraphInputSSA + " = OpGraphInputARM " + ssa.first + " %uint_0";
    id++;
  }
...
TEST_F(GraphShapeMultiOpTestPass, Conv2d_Conv2d_Concat) {
  ...
  shader += R"(
    ...
    %graph_input3_CONV2D_1 = OpGraphInputARM %input0_CONV2D_0_type %uint_0
    %graph_input4_CONV2D_1 = OpGraphInputARM %input0_CONV2D_0_type %uint_1
    %graph_input5 = OpGraphInputARM %input1_CONV2D_0_type %uint_2
    ...
    ; CHECK: [[graph_input1:%\w+]] = OpGraphInputARM [[input1_type]] %uint_1
    ; CHECK: [[graph_input2:%\w+]] = OpGraphInputARM [[input2_type]] %uint_2
    ; CHECK: [[graph_input3:%\w+]] = OpGraphInputARM [[input3_type]] %uint_0
    ; CHECK: [[graph_input4:%\w+]] = OpGraphInputARM [[input4_type]] %uint_1
    ; CHECK: [[graph_input5:%\w+]] = OpGraphInputARM [[input2_type]] %uint_2
